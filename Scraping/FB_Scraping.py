...
url = 'https://www.facebook.com/groups/1656386581122146?locale=th_TH'
driver.get(url)
...
df.to_csv("facebook_scrap.csv", index=False, encoding='utf-8-sig')
print("Data saved successfully: facebook_scrap.csv")